...
export default {
  ...
  data() {
    return {
      ...
      argeeRules: [{ validate: (val) => !!val, message: '请选择同意用户协议' }],
      validateForm: {
        username: '',
        password: '',
        isAgree: false
    ...
    submit() {
      this.$refs.form.validate().then((result) => {
        ...
        let user = {
          ...
          username: 'zhent',
          userRole: 'admin',
          avatar: 'https://avatars3.githubusercontent.com/u/45093305?s=60&u=7e544a5fd38e1659684554ce1e119db8d192d2eb&v=4'
        }
        this.menuList = [
